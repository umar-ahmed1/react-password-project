      ...
      >
        <Flex width={{ base: '100%', sm: '90%' }} mb={5} align='center' justify='center' direction='column' textAlign='center'>
          ...
          >
            ...
            <Heading fontWeight={700} fontSize='15px'>Our Algorithm uses the<Heading fontSize='15px' color='red.400'>zxcvbn</Heading>password strength estimator, an open-source library developed by Dropbox</Heading> 
        </Flex>  
      </Flex>
      <Flex width={{base:'100%',md:"70%"}} direction={{base:'column',md:'row'}} align={{base:'center',md:'flex-start'}} justify='center'>
          <Text width="50%" mr={{base:0,md:4}} mb={{base:8,md:0}} textAlign='center' border='1px solid' borderColor='blue.400' p={3}>
          ...
          <Text ml={{base:0,md:4}} width="50%" textAlign='center' border='1px solid' borderColor='blue.400' p={3}>
